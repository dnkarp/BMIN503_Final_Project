...
+[1b]Load Libraries
```{r load libraries, eval=TRUE, echo=FALSE} 
###--LIBRARIES--###----
...
+[1e]Generate Descriptive Statistics
```{r descriptive stats continued, eval=TRUE}
...
```{r pre-process data 2, eval=FALSE}
...
```{r descriptive stats 3, eval=TRUE}
...
```{r spatial analysis 2, eval=TRUE}
###--GEOGRAPHIC VARIATION: TESTING SPATIAL AUTOCORRELATION--###----
...
```{r spatial analysis 3, eval=TRUE}
###--GEOGRAPHIC VARIATION: TESTING SPATIAL AUTOCORRELATION--###----
